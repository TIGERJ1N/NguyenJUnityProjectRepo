...
* This file manages the prefabs that the game spawns during gameplay.
* Changed was the OnMouseEnter() method to OnMouseDown(), so that the game only destroys the prefabs when the player CLICKS on the objects, not HOVERS OVER THEM.
*/
...
public class TargetX : MonoBehaviour
{
    ...
    private void OnMouseDown() // ALTERED: OnMouseEnter() --> OnMouseDown()
    {
